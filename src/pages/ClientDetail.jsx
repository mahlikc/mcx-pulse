...
export default function ClientDetail() {
  ...
  return (
    <>
      ...
      <div className="grid4">
        <div className="panel"><div className="bignum">{fmt2(w7.mer)}</div><div className="metric"><div className="k">7d MER {w7.revenueSource === 'store' ? '(store rev)' : '(meta rev)'}</div></div></div>
